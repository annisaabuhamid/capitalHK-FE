...
!(function (a, b) {
  ...
  function s(a) {
    var b = !!a && "length" in a && a.length,
      c = n.type(a)
    return (
      "function" !== c && !n.isWindow(a) && ("array" === c || 0 === b || ("number" == typeof b && b > 0 && b - 1 in a))
    )
  }
  var t = (function (a) {
    var b,
      ...
      for (
        ...
        if ((c = d.relative[a[i].type])) m = [qa(ra(m), c)]
          ...
          if (((c = d.filter[a[i].type].apply(null, a[i].matches)), c[u])) {
            ...
            return ua(
              i > 1 && ra(m),
              i > 1 && pa(a.slice(0, i - 1).concat({ value: " " === a[i - 2].type ? "*" : "" })).replace(Q, "$1"),
              c,
              i < e && va(a.slice(i, e)),
              e < f && va((a = a.slice(e))),
              e < f && pa(a)
    ...
    n.extend({
      ...
      ready: function (a) {
        ;(!0 === a ? --n.readyWait : n.isReady) ||
          ((n.isReady = !0),
          (!0 !== a && --n.readyWait > 0) ||
            (H.resolveWith(d, [n]), n.fn.triggerHandler && (n(d).triggerHandler("ready"), n(d).off("ready"))))
      },
    })
  function I() {
    d.addEventListener
  ...
  ;(n.ready.promise = function (b) {
    if (!H)
      if (
        ((H = n.Deferred()), "complete" === d.readyState || ("loading" !== d.readyState && !d.documentElement.doScroll))
      )
    ...
    if (void 0 === c && 1 === a.nodeType) {
      ...
      if ("string" == typeof (c = a.getAttribute(d))) {
        try {
          c =
            "true" === c ||
            ("false" !== c && ("null" === c ? null : +c + "" === c ? +c : M.test(c) ? n.parseJSON(c) : c))
        } catch (e) {}
        n.data(a, b, c)
      } else c = void 0
    }
      ...
      if (r && (k = r.events)) {
        ...
        while (j--)
          if (((h = na.exec(b[j]) || []), (o = q = h[1]), (p = (h[2] || "").split(".").sort()), o)) {
            ...
            i &&
              !m.length &&
              ((l.teardown && !1 !== l.teardown.call(a, p, r.handle)) || n.removeEvent(a, o, r.handle), delete k[o])
        ...
        while ((f = h[b++]) && !a.isPropagationStopped()) {
          ...
          while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped())
            (a.rnamespace && !a.rnamespace.test(g.namespace)) ||
              ((a.handleObj = g),
              (a.data = g.data),
              void 0 !== (d = ((n.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, i)) &&
                !1 === (a.result = d) &&
      ...
      a && a.type
        ? ((this.originalEvent = a),
          ...
          (this.isDefaultPrevented =
            a.defaultPrevented || (void 0 === a.defaultPrevented && !1 === a.returnValue) ? oa : pa))
        : (this.type = a),
        b && n.extend(this, b),
  ...
  function Ga(a, b, c, d) {
    ...
    if (
      o &&
      ((k = ia(b, a[0].ownerDocument, !1, a, d)), (e = k.firstChild), 1 === k.childNodes.length && (k = e), e || d)
    ) {
  ...
  function La(a) {
    ...
    return (
      c ||
        ((c = Ka(a, b)),
        ("none" !== c && c) ||
          ((Ia = (Ia || n("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement)),
    ...
    c.queue ||
      ...
      1 === a.nodeType &&
        ...
        "inline" === (k = "none" === j ? n._data(a, "olddisplay") || La(a.nodeName) : j) &&
          "none" === n.css(a, "float") &&
          (l.inlineBlockNeedsLayout && "inline" !== La(a.nodeName) ? (p.zoom = 1) : (p.display = "inline-block"))),
      c.overflow &&
        ((p.overflow = "hidden"),
        l.shrinkWrapBlocks() ||
          m.always(function () {
    ...
    ajax: function (b, c) {
      ...
      ;(i = n.event && l.global),
        ...
        l.hasContent ||
          ...
          !1 === l.cache &&
            (l.url = Hb.test(f) ? f.replace(Hb, "$1_=" + Db++) : f + (Eb.test(f) ? "&" : "?") + "_=" + Db++)),
        l.ifModified &&
