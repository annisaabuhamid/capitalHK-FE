...
declare namespace googletag {
  ...
  namespace config {
     ...
     *
     * All properties listed below are examples and do not reflect actual features that utilize setConfig.
     * For the set of features, see fields within the {@link PageSettingsConfig} type below.
     *
  ...
  namespace events {
     ...
     * To determine whether a reward has been granted, use {@link events.RewardedSlotGrantedEvent} instead.
     *
     * @example
     ...
     * If you need to know when all creative resources for a slot have finished loading, consider the {@link events.SlotOnloadEvent} instead.
     *
     * @example
    ...
    interface SlotRenderEndedEvent extends Event {
       ...
       * Value is `null` for empty slots, reservation ads, and creatives rendered by services other than {@link PubAdsService}.
       */
  ...
  namespace secureSignals {
    ...
    interface SecureSignalProvidersArray {
      ...
      /**
       * Adds a new {@link secureSignals.SecureSignalProvider} to the signal provider array and begins the signal generation process.
       * @param provider The {@link secureSignals.SecureSignalProvider} object to be added to the array.
       */
