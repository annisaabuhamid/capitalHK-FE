/* eslint-disable */
export function smoothScroll(windowObject) {
      ...
      function ScrollSmoother(t) {
        ...
        function Fa(e) {
          return arguments.length
            ? (e < 0 && (e = 0), (M.y = -e), (d = !0), u ? (A = -e) : Ea(-e), j.isRefreshing ? i.update() : _(e), this)
            : -A
        }
        function Ha(e) {
          ;(b.scrollTop = 0),
            (e.target.contains && e.target.contains(b)) ||
              (E && !1 === E(o, e)) ||
              (j.isInViewport(e.target) || e.target === g || o.scrollTo(e.target, !1, "center center"), (g = e.target))
        }
        function Ia(e) {
          var r, n, o, i
