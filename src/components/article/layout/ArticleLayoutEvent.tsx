...
import OtherEventArticle from "@/components/article/component/OtherEventArticle"
...
import { getParentCategory, renderRootPath } from "@/utils"
...
function ArticleLayoutEvent({ article, titleVariant, percentage }: Props) {
  const {
    ad_banner_side,
    imageUrl,
    date,
  ...
  return (
    <div className="flex lg:ml-[10.5%] mb-9" ref={container}>
      ...
      <div className="w-full max-w-full pt-4 lg:mx-0  lg:max-w-[593px] xl:max-w-[728px] flex-1">
        ...
        /> */}
        <OtherEventArticle otherEventArticles={otherEventArticles} />
...
export default ArticleLayoutEvent
