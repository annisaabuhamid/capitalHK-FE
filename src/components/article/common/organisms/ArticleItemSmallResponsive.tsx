...
function ArticleItemSmallResponsive({
  title,
  tag,
  date,
  articleId,
    ...
    <ArticleItemLinkWrapper className="article-item-small" slug={slug ?? ""} categories={categories}>
      <div
        className={clsx({
          ...
          "gap-5 flex items-start w-full lg:border-b py-4 justify-between lg:py-6":
            articleItemVariant === "categoryHorizontal" && index !== 0,
          "gap-5 flex items-start w-full lg:outline-1 lg:outline  py-4 lg:outline-[#E5E5E5] lg:py-6":
            articleItemVariant === "categoryHorizontal" && index === 0,
      ...
      >
        ...
        <div className={`relative image-container md:aspect-[3/2]`}>
          ...
          <ResponsiveImageContainer
            imgUrl={!!imageFormats?.small?.url ? imageFormats?.small?.url : imageUrl}
...
export default ArticleItemSmallResponsive
